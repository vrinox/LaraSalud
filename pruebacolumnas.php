...
<section id="Articulos">
    ...
    <div class="row pt-4">
      <div class="col-sm-475">
        ...
        <!--Tarjeta numero 1 (abajo del carrusel)-->
         <div class="card mb-2 mt-2" style="max-width: 540px;">
          <div class="row no-gutters text-center">
            ...
            <div class="col-lg-8" style="margin:0px auto;">
              <div class="card-body pt-1" >
                ...
                <p class="card-text p-small e-1 text-justify">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. This is a wider card.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row p-0">
        ...
        <div class="col-md-3 p-0">
          ...
          <iframe id="calendario" src="https://calendar.google.com/calendar/embed?height=200&amp;wkst=1&amp;bgcolor=%23ffffff&amp;ctz=America%2FCaracas&amp;src=NHNtYTF1MTU2c2x0ajliMjBkMmIzdXU2dWtAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ&amp;color=%23009688&amp;showNav=1&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0" style="border-width:0" width="300" height="200" frameborder="0" scrolling="no"></iframe>                   
          </div>
        </div>
      </div>
    </div>
        ...
        <div id="carouselIndicators" class="carousel slide w-99" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active w-33">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100 mr-2" alt="antivacuna">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100 mr-2" alt="antivacuna">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100" alt="menopausia">
            </div>
            <div class="carousel-item w-33">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100 mr-2" alt="menopausia">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100 mr-2" alt="antivacuna">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100" alt="menopausia">
            </div>
            <div class="carousel-item w-33">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100 mr-2" alt="intoxicacion">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100 mr-2" alt="antivacuna">
              <img src="imagenes/carrusel/hemosvuelto.jpg" class="d-flex w-100" alt="menopausia">
            </div>
          </div>
  ...
  <div id="mColaboradores" class="col-sm-25 p-0" style="background-color: rgb(199,237,227)">  
        ...
        <div class="contenedor">
          <div class="row no-gutters active">
            <div class="col-sm-5 d-flex text-center">
              <img src="imagenes/medicos/ESTEFANY ECHEVERRIA - ECOGRAFISTA.jpg" class="pl-2 pt-2" style="width:90%; height:80%; border-radius:50%;" alt="estefany">
            </div>
            <div class="col-sm-7 d-flex">
              <div class="card-bod p-1">
                <h6 class="card-title font-weight-bold mb-1">Dra. Estefany Echeverria</h6>
