<?php
    ...
    $query= "SELECT * FROM especialidades WHERE profesional='O';";
    $resultado= db_query($query);
    $numeroEsp = mysqli_num_rows($resultado);
    $mitad = (int) ($numeroEsp/2);
    $cont = 1;
    while($fila=mysqli_fetch_array($resultado))
    {
        if($cont <= $mitad){
            if($cont==1 || $cont%2!=0)
            {
              $listaEsp .= "<a href=\"https://larasalud.com/larasalud-OEmedicos.php?especialidad=".$fila['especialidad']."&profesional=O\" style=\"text-decoration:none\"><span class=\"pr-1 w-25 h-25 float-left circulo\"></span><div class=\"especialidades\" style=\"background-color: #e4e0e0;\"><h4>".$fila['especialidad']."</h4></div></a>";
            }    
            else
            {
                $listaEsp .= "<a href=\"https://larasalud.com/larasalud-OEmedicos.php?especialidad=".$fila['especialidad']."&profesional=O\" style=\"text-decoration:none\"><span class=\"pr-1 w-25 h-25 float-left circulo\"></span><div class=\"especialidades\" style=\"background-color:  #c0bebe;\"><h4>".$fila['especialidad']."</h4></div></a>";
            }
        }
        else
        {
...
<head>
<title>LS - Otras especialidades</title>
<?php include 'php/header.php'; ?>
  <section id="Directorio">
    ...
    <h1 class="ml-4 mt-4 mb-0" style="color:#969494;">DIRECTORIO / OTRAS ESPECIALIDADES</h1>
    
    <div class="row pt-4 ml-2">
      <div id="Oespecialidades" class="col-sm-475 pr-1 h-80">
       
     <?php echo $listaEsp; ?>
     </div>
      <div class="col-sm-25 pl-1 pr-1">
        <div class="mb-4"><img class="img-fluid publicidad" src="https://via.placeholder.com/230x588"></div>
       <!-- <div><img class="img-fluid publicidad" src="https://via.placeholder.com/230x550"></div> -->
      </div>
    </div>
  </section>
